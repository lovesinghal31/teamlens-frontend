...
const mockMeetings: Meeting[] = [
  {
    ...
    date: getDateForCurrentWeek(0), // Mon
    startHour: 9,
    startMinute: 0,
    endHour: 10,
    endMinute: 0,
    ...
    tasks: [
      {
        title: "Resolve CI Pipeline Failure",
        assignee: people.ds,
        progress: 60,
        status: "at-risk",
      },
  ...
  },
  {
    ...
    date: getDateForCurrentWeek(1), // Tue
    startHour: 10,
    startMinute: 0,
    endHour: 11,
    endMinute: 0,
    ...
    aiReasoning:
      "Predefined quarterly planning meeting. Scheduled at the start of each quarter to align team goals.",
    agenda: [
  ...
  },
  {
    ...
    date: getDateForCurrentWeek(3), // Thu
    startHour: 9,
    startMinute: 30,
    endHour: 10,
    endMinute: 0,
  ...
  },
  {
    ...
    date: getDateForCurrentWeek(2), // Wed
    startHour: 14,
    startMinute: 0,
    endHour: 15,
    endMinute: 0,
  ...
  },
  {
    ...
    date: getDateForCurrentWeek(4), // Fri
    startHour: 15,
    startMinute: 0,
    endHour: 16,
    endMinute: 0,
  ...
  },
  {
    ...
    date: getDateForCurrentWeek(5), // Sat
    startHour: 11,
    startMinute: 0,
    endHour: 11,
    endMinute: 30,
    ...
    tags: ["1:1", "MENTORING"],
    aiReasoning:
      "Predefined weekly 1:1 between Divyansh and Uthkarsh for mentoring and growth check-ins.",
    agenda: [
